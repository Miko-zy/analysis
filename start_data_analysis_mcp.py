...
# 设置MCP接入点（如果环境变量未设置）
if not os.environ.get('MCP_ENDPOINT'):
    os.environ['MCP_ENDPOINT'] = 'wss://api.xiaozhi.me/mcp/?token=eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjUwNzc5MiwiYWdlbnRJZCI6NzMxOTUwLCJlbmRwb2ludElkIjoiYWdlbnRfNzMxOTUwIiwicHVycG9zZSI6Im1jcC1lbmRwb2ludCIsImlhdCI6MTc2NTQ0NTI4NiwiZXhwIjoxNzk3MDAyODg2fQ.f4h-eSv3MwHp6gRyfjJal8qmdgg-Yub7EjkDpfX5Ms-h1dmIcnLoY-1GVEMy59NaF4hhSIeTo2LsmLRR3-6Kgg'
    ...
    try:
        ...
        async with websockets.connect(uri) as websocket:
            ...
            process = subprocess.Popen(
                [sys.executable, "data_analysis_tool10.py"],
